...
class FileBasedServiceRegistry {
    ...
    register(serviceName, serviceInfo) {
        ...
        // Garantir que a URL use 127.0.0.1 em vez de localhost
        const fixedServiceInfo = {
            ...serviceInfo,
            url: serviceInfo.url.replace('localhost', '127.0.0.1'),
        ...
        services[serviceName] = fixedServiceInfo;
        
        this.writeRegistry(services);
        console.log(`Serviço registrado: ${serviceName} - ${fixedServiceInfo.url} (PID: ${process.pid})`);
    ...
    async performHealthChecks() {
        ...
        for (const [serviceName, service] of Object.entries(services)) {
            try {
                // Usar a URL já corrigida (com 127.0.0.1)
